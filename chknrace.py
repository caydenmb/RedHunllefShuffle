...
formats the top 9 wagerers (positions 1–9) and serves JSON at /data for the frontend.
...
# Your Shuffle.com API key and URL template
...
# Fixed race start time (April 22 2025 21:27:35 EDT)
...
def fetch_data():
    """Fetch raw stats from Shuffle API, filter by campaign 'Red', and update cache."""
    global data_cache
    ...
    try:
        ...
        log_message('debug', f"Response status {resp.status_code}")
...
def update_placeholder_data():
    """Sort by wagerAmount, take top 9, format into data_cache as top1..top9."""
    global data_cache
...
def schedule_data_fetch():
    ...
    log_message('info', 'Scheduling next fetch in 90 seconds')
    fetch_data()
